...
[![GitHub](https://img.shields.io/badge/作者-nuomicici-blue)](https://github.com/nuomicici)
...
| 命令 (支持多种别名) | 功能描述 | 备注 |
| :--- | :--- | :--- |
| `抽老婆` | 抽取一位群友作为老婆，结果会附带头像并 `@` 该成员。 | |
| `我的老婆` | 查看你今天抽到的所有老婆的历史记录和剩余次数。 | |
| `重置记录` | 清空今天所有的抽取记录。 | 需要bot管理员权限 |
| `抽老婆帮助` | 显示插件的帮助信息、命令列表和当前配置。 | |
