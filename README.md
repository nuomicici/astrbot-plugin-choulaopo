![Visitor Count](https://count.getloli.com/@astrbot-plugin-choulaopo?name=astrbot-plugin-choulaopo?theme=minecraft&padding=6&offset=0&align=top&scale=1&pixelated=1&darkmode=auto)
# 随机抽老婆插件 v2.0.3
